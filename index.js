...
var RGBColor = function(color_string) {
     ...
     * returns h, s, and l are contained in the set [0..1].
     *
    ...
    /*
     * Returns a new RGBColor that is a given absolute amount darker than the receiver.
     * Example:
     *          var darkerRed = (new RGBColor('#FF0000')).darken(0.2);
     */
